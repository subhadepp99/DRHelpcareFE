    ...
    >
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {searchTypes.map((type) => (
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-1.5 rounded-md text-xs sm:text-sm font-medium transition-all duration-200 ${
      ...
      <form onSubmit={handleSubmit} className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="flex-1 relative" ref={searchRef}>
                ...
                <input
                  ...
                  className="w-full pl-9 pr-9 py-1.5 sm:pl-10 sm:pr-10 sm:py-2 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white text-gray-900 placeholder-gray-500 dark:placeholder-gray-400 text-sm sm:text-base"
                />
                {searchQuery ? (
                  <button
                    type="button"
              ...
              <div className="flex-1 relative" ref={locationRef}>
                <button
                  ...
                  className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 z-10 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                ...
                <input
                  ...
                  className="w-full pl-9 pr-20 py-1.5 sm:pl-10 sm:pr-24 sm:py-2 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white text-gray-900 placeholder-gray-500 dark:placeholder-gray-400 cursor-pointer text-sm sm:text-base"
                  autoComplete="off"
                  readOnly
                />
                {locationInput && (
              ...
              <button
                ...
                className={`group relative font-semibold px-5 py-2 text-sm sm:px-8 sm:py-3 rounded-lg transition-all duration-300 transform focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${
                  (searchQuery || "").trim()
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {specialtyPills.map((spec) => (
                <button
                  key={spec}
                  type="button"
                  className="px-2 py-1 text-xs rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-primary-100 dark:hover:bg-primary-900 text-gray-700 dark:text-gray-200 hover:text-primary-700 dark:hover:text-primary-300 sm:px-3 sm:py-1.5"
                  onClick={() => {
        ...
        */}
        {false && (
          <AnimatePresence>
            <motion.div>{/* Advanced Filters Panel - DISABLED */}</motion.div>
          </AnimatePresence>
        )}
      </form>
